...
const insertProduct = (id, name, price) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [result] = yield db_1.promisePool.query("INSERT INTO product (id, name, price) VALUES (?, ?, ?)", [6604101366, 'ภานุสรณ์ คำโคกกรวด', price]);
...
const updateProduct = (id, name, price) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [result] = yield db_1.promisePool.query("UPDATE product SET name = ?, price = ? WHERE id = ?", ['ภานุสรณ์ คำโคกกรวด', price, 6604101366]);
